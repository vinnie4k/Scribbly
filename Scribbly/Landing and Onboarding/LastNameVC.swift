...
class LastNameVC: UIViewController, UITextFieldDelegate {
    ...
    @objc private func nextPage() {
        let usernameVC = UsernameVC(firstName: firstName, lastName: textField.text!.lowercased())
        let nav = UINavigationController(rootViewController: usernameVC)
