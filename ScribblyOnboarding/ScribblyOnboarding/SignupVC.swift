...
class SignupVC: UIViewController {
    ...
    private let confirmpasswrdtxt: UILabel = {
        let lbl = UILabel()
    ...
    private let confirmpasswordform: UITextField = {
        let txt_field = UITextField()
        txt_field.textColor = OnboardConstants.text_dark
        txt_field.font = OnboardConstants.description_font
        txt_field.tintColor = OnboardConstants.secondary_text
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(confirmpasswrdtxt)
        view.addSubview(confirmpasswordform)
        
        trdparty.image = UIImage(named: "thirdparty")
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            confirmpasswrdtxt.topAnchor.constraint(equalTo: passwordform.bottomAnchor, constant: 24),
            confirmpasswrdtxt.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24)
        ])
        
        NSLayoutConstraint.activate([
            confirmpasswordform.topAnchor.constraint(equalTo: confirmpasswrdtxt.bottomAnchor, constant: 8),
            confirmpasswordform.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24),
            confirmpasswordform.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -24)
        ])
        
        
        NSLayoutConstraint.activate([
            trdparty.topAnchor.constraint(equalTo: confirmpasswordform.bottomAnchor, constant: 48),
