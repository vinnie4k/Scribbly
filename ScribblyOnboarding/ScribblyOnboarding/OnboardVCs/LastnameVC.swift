...
class LastnameVC: UIViewController {
    ...
    private let question: UILabel = {
        let lbl = UILabel()
        lbl.text = "welcome, liam! and your last name?"
    ...
    private let forms: UITextField = {
        ...
        txt_field.placeholder = "your last name"
    ...
    private let carousel: UIImageView = {
        ...
        carousel.image = UIImage(named: "carouselpos4")
    ...
    @objc func previousview(){
        navigationController?.pushViewController(FirstnameVC(), animated: false)
    }
    
    @objc func nextview(){
        navigationController?.pushViewController(UploadpictureVC(), animated: false)
    }
